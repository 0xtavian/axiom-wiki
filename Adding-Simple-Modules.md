...
Next the binary is called, `/usr/bin/dnsx`. Always make sure you add the full path of the binary for all modules. You can find the path with the command `which`.
