...
> - [Default](https://github.com/pry0cc/axiom/blob/master/images/provisioners/default.json) is our latest iteration of axiom provisioners. It comes with all tools installed and has been optimized for readability. It is recommended for axiom-fleet/axiom-scan and uses Barebones as a base template.
...
> - [Barebones](https://github.com/pry0cc/axiom/blob/master/images/provisioners/barebones.json) is our decently secure base install. It comes with Docker, Go-lang, Interlace and nmap installed. Recommended for templating.
